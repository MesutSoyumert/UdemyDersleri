...
namespace LinqProject
{
    internal class Program
    {
        static void Main(string[] args)
        {
            ...
            //IEnumerable<ProductDto> result = ClassicLinqTest(products);
            ...
            foreach (var productDto in result)
            {
                Console.WriteLine
                    (
                    "{0} --- {1} --- {2} --- {3}",
                    productDto.ProductId, productDto.ProductName, productDto.CategoryName, productDto.UnitPrice                
                    );

                //Console.WriteLine(productDto.ProductId + " " +
        ...
        private static IEnumerable<ProductDto> ClassicLinqTest(List<Product> products)
        {
        ...
        private static void AscDescTest(List<Product> products)
        {
            var result = products.Where
                (
                //single line query
                product => product.ProductName.Contains("top")
        ...
        {
            var result = products.Find(p => p.ProductId == 13);
        ...
        private static void TestLinq(List<Product> products)
        {
            ...
            var result = products.Where(
                p => p.UnitPrice > 5000 && p.UnitsInStock > 3
                );
